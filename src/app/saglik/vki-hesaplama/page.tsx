...
export const metadata: Metadata = {
  ...
  description: "En doğru Vücut Kitle İndeksi (VKİ) hesaplaması için güncel aracımızı kullanın. İdeal kilo aralığınızı ve sağlık durumunuzu öğrenin.",
  keywords: ["vki hesaplama", "vücut kitle indeksi", "bmi hesaplama", "boy kilo endeksi"],
  robots: {
    index: false,
    follow: true,
  },
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-xl p-8 text-center">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Vücut Kitle İndeksi Hesaplama</h1>
        <p className="text-lg text-gray-600 mb-6">
          "VKİ Hesaplama" aracımız, daha kapsamlı ve detaylı sonuçlar sunan ana "Vücut Kitle İndeksi Hesaplama" sayfamıza taşınmıştır.
        </p>
        <AdBanner />
        <div className="mt-8">
