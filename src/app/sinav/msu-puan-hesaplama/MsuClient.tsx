...
const MsuClient = () => {
    ...
    const calculate = async (inputs: { [key: string]: any }): Promise<CalculationResult | null> => {
        ...
        const summary = {
            say: { label: 'MSÜ-SAYISAL Puanı', value: formatNumber(hamPuanlar.SAY), isHighlighted: true },
            soz: { label: 'MSÜ-SÖZEL Puanı', value: formatNumber(hamPuanlar.SOZ), isHighlighted: true },
            ea: { label: 'MSÜ-EŞİT AĞIRLIK Puanı', value: formatNumber(hamPuanlar.EA), isHighlighted: true },
            genel: { label: 'MSÜ-GENEL Puan', value: formatNumber(hamPuanlar.GENEL), isHighlighted: true },
        };
